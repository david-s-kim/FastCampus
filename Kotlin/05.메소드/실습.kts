...
// 기본값이 있는 함수
fun plusNumbersWihtDfualt(firstNum: Int, secondNum: Int = 10): Int {
    return firstNum + secondNum
}

val result2: Int = plusNumbersWihtDfualt(firstNum = 10)
println(result2)
val result3: Int = plusNumbersWihtDfualt(firstNum = 10, secondNum = 20)
println(result3)
