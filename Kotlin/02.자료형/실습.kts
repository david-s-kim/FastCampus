...
val doubleNubmer: Double = 10.0 // Double의 경우에는 할당하려는 값 뒤에 아무것도 붙이지 않아도 된다.
//val doubleNubmer: Double = 10 // 10과 10.0은 같지만 .을 찍어서 실수형이라는 것을 표현해야한다.
...
// 변수명
// val true : Int = 10 -> 코틀린에서 선점해서 사용하고 있는 키워드는 변수명으로 사용할 수 없다.
