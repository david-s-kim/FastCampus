...
if (number1 == 10) { // 조건식은 무조건 true또는 false로 결과가 나와야한다.
    ...
    println("10, 20 둘다 아닙니다.")명}

// 간단하게 사용하는 방법
if (number1 == 10) println("10입니다.")
else if (number1 == 20) println("20입니다.")
else if (number1 == 30) println("30입니다.")
else if (number1 == 40) println("40입니다.")
else println("10, 20, 30, 40 둘다 아닙니다.")

val number2: Int = 10 + 20 // 우항은 값이 오면 된다. -> 식이 와도 된다.
...
// boolean을 반환하는 식
when (number4){
    in 1..5 -> println("number4 is in 1..10") // number4 in 1..10 -> Boolean
    in 20..30 -> println("number4 is in 20..30")
    in 40..60 -> println("number4 is in 40..60")
}
